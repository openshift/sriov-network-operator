...
BOND_IMAGE_DIGEST=$(skopeo inspect docker://quay.io/openshift/origin-network-interface-bond-cni | jq --raw-output '.Digest')
...
export BOND_CNI_BINARY_DAEMON_IMAGE=${BOND_CNI_BINARY_DAEMON_IMAGE:-quay.io/openshift/origin-network-interface-bond-cni@${BOND_IMAGE_DIGEST}}
