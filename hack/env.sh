...
BOND_IMAGE_DIGEST=$(skopeo inspect docker://quay.io/openshift/origin-bond-cni-daemon | jq --raw-output '.Digest')
...
export BOND_CNI_BINARY_DAEMON_IMAGE=${BOND_CNI_BINARY_DAEMON_IMAGE:-quay.io/openshift/origin-bond-cni-daemon@${BOND_IMAGE_DIGEST}}
