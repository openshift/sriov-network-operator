...
var SriovNetworkPfVfMap = map[string](string){
	"1583": "154c",
	"158b": "154c",
	"10fb": "10ed",
	"1015": "1016",
...
func init() {
	for _, v := range SriovNetworkPfVfMap {
		id := "0x" + v
...
type NetworkPolicyByPriority []SriovNetworkNodePolicy

func (a NetworkPolicyByPriority) Len() int {
	return len(a)
}

func (a NetworkPolicyByPriority) Less(i, j int) bool {
...
func (a NetworkPolicyByPriority) Swap(i, j int) {
	a[i], a[j] = a[j], a[i]
}
