...
var _ = BeforeSuite(func() {
	...
	vars.ResourcePrefix = "sriovoperator.io"
	...
	infra.Status = openshiftconfigv1.InfrastructureStatus{
	...
	Expect(k8sClient.Status().Update(context.Background(), infra)).Should(Succeed())
})
